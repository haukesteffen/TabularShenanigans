...
def _default_cases() -> list[ValidationCase]:
    return [
        ...
        ValidationCase(
            ...
            notes="Validates #213 — ordinal GPU path fires before patch fallback even under patch backend.",
        ),
        ValidationCase(
        ...
        # #213: ordinal categorical on GPU via cuDF map
        ValidationCase(
            case_id="binary_logistic_native_ordinal_median",
            template_config_path=DEFAULT_BINARY_TEMPLATE_PATH,
            model_family="logistic_regression",
            numeric_preprocessor="median",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #213 — logistic regression ordinal routes to gpu_cuml via cuDF map.",
        ),
        ValidationCase(
            case_id="regression_ridge_native_ordinal_standardize",
            template_config_path=DEFAULT_REGRESSION_TEMPLATE_PATH,
            model_family="ridge",
            numeric_preprocessor="standardize",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #213 — ridge ordinal routes to gpu_cuml via cuDF map.",
        ),
        ValidationCase(
            case_id="regression_elasticnet_native_ordinal_kbins",
            template_config_path=DEFAULT_REGRESSION_TEMPLATE_PATH,
            model_family="elasticnet",
            numeric_preprocessor="kbins",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #213 — elasticnet ordinal+kbins routes to gpu_cuml via cuDF map.",
        ),
        ValidationCase(
            case_id="regression_random_forest_native_ordinal_median",
            template_config_path=DEFAULT_REGRESSION_TEMPLATE_PATH,
            model_family="random_forest",
            numeric_preprocessor="median",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #213 — random forest ordinal routes to gpu_cuml via cuDF map.",
        ),
        ValidationCase(
            case_id="regression_lightgbm_native_ordinal_kbins",
            template_config_path=DEFAULT_REGRESSION_TEMPLATE_PATH,
            model_family="lightgbm",
            numeric_preprocessor="kbins",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #213 — lightgbm ordinal+kbins routes to gpu_cuml via cuDF map.",
        ),
        # #216: extend native registry — logreg+frequency, xgboost+ordinal, xgboost+kbins+frequency
        ValidationCase(
            case_id="binary_logistic_native_frequency_median",
            template_config_path=DEFAULT_BINARY_TEMPLATE_PATH,
            model_family="logistic_regression",
            numeric_preprocessor="median",
            categorical_preprocessor="frequency",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_native_frequency",
            notes="Validates #216 — logreg+median+frequency now registered as gpu_native.",
        ),
        ValidationCase(
            case_id="binary_logistic_native_frequency_kbins",
            template_config_path=DEFAULT_BINARY_TEMPLATE_PATH,
            model_family="logistic_regression",
            numeric_preprocessor="kbins",
            categorical_preprocessor="frequency",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_native_frequency",
            notes="Validates #216 — logreg+kbins+frequency now registered as gpu_native.",
        ),
        ValidationCase(
            case_id="binary_xgboost_native_ordinal_median",
            template_config_path=DEFAULT_BINARY_TEMPLATE_PATH,
            model_family="xgboost",
            numeric_preprocessor="median",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #216 — xgboost+ordinal now registered as gpu_native.",
        ),
        ValidationCase(
            case_id="regression_xgboost_native_ordinal_kbins",
            template_config_path=DEFAULT_REGRESSION_TEMPLATE_PATH,
            model_family="xgboost",
            numeric_preprocessor="kbins",
            categorical_preprocessor="ordinal",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_cuml",
            notes="Validates #216 — xgboost+ordinal+kbins now registered as gpu_native.",
        ),
        ValidationCase(
            case_id="binary_xgboost_native_frequency_kbins",
            template_config_path=DEFAULT_BINARY_TEMPLATE_PATH,
            model_family="xgboost",
            numeric_preprocessor="kbins",
            categorical_preprocessor="frequency",
            gpu_backend="native",
            expected_preprocessing_backend="gpu_native_frequency",
            notes="Validates #216 — xgboost+kbins+frequency now registered as gpu_native.",
        ),
    ]
